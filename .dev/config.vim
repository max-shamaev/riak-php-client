...
" PHP documentor tags
let g:pdv_cfg_Package    = "RiakAPI"
let g:pdv_cfg_Author1    = "Rusty Klophaus (@rklophaus) (rusty@basho.com)"
let g:pdv_cfg_Author2    = "Maxim Shamaev (maxim.shamaev@gmail.com)"
let g:pdv_cfg_License    = "Apache License 2.0 http://www.apache.org/licenses/LICENSE-2.0"
let g:pdv_cfg_Since      = "1.0.0"
let g:pdv_cfg_Link       = "http://www.basho.com/"
...
func! Project_PhpDocFile()
    ...
    exe l:txtBOL . g:pdv_cfg_Commentn . "@author  " . g:pdv_cfg_Author2 g:pdv_cfg_EOL

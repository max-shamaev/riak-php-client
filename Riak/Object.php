...
class Object
{
    ...
    {
        return intval($this->headers['http_code']);
    }
    ...
    public function store($w = null, $dw = null)
    {
        ...
        $url = \Riak\Utils::buildRestPath($this->client, $this->bucket, $this->key, null, $params);
    ...
    public function reload($r = null)
    {
        ...
        $url = \Riak\Utils::buildRestPath($this->client, $this->bucket, $this->key, null, array('r' => $r));
    ...
    public function delete($dw = null)
    {
        ...
        // Construct the URL...
        $url = \Riak\Utils::buildRestPath($this->client, $this->bucket, $this->key, null, array('dw' => $dw));
